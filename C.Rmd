...
&\Updownarrow \\
\lambda^{(t+1)}_0 &= \frac{\sum_{i=1}^n  \bigg[ u_iz_i +  (1-u_i)\frac{e^{-\lambda_0^{(t)}z_i}(1-z_i) -1} {1- e^{-z_i\lambda_0^{(t)}}} \bigg]}{n}, \\
\lambda^{(t+1)}_1 &= \frac{\sum_{i=1}^n \bigg[ (1-u_i)z_i + u_i \frac{e^{-\lambda_0^{(t)}z_i}(1-z_i) -1} {1- e^{-z_i\lambda_0^{(t)}}} \bigg]}{n}.
\end{aligned}
$$
