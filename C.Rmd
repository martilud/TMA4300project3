...
This is were the iterative EM-style comes into play. Since we need to know our data $\vect{x}, \vect{y}$ in order to maximize the parameters, and we need our parameters to get our best guess on our unobserved data, we do exactly that:
...
* Maximize the likelihood using our approximated values and obtain new maximized parameters.

* Stop the algorithm when the new parameter guesses in the M-step and the parameters on which the data is based on is the E-step are coinciding.
